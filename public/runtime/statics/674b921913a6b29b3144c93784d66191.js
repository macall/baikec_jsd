...
eval(function(p,a,c,k,e,d){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--){d[e(c)]=k[c]||e(c)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('$(A).1Q(3(){1z();1v();1k();1l()});3 1k(){$("#1W").o("r",3(){V()})}3 1l(){$("#1T").o("r",3(){2 c=1j 1i();c.1h="1U";c.1f=1g;$.1m({1n:1s,1t:c,1r:"1q",M:"1o",1p:3(7){4(7.E==D){1e()}a 4(7.E==1){$.20(7.J)}a{$.11(7.J)}}})})}3 V(){2 c=1j 1i();c.1f=1g;c.1h="1V";$.1m({1n:1s,1t:c,1r:"1q",M:"1o",1p:3(7){4(7.E==D){1e()}a 4(7.E==1){$.1O.1N(7.g,{1M:"1L",1Z:p,27:"领取优惠券",w:21,M:\'2i\',2g:3(){2 15=v($("#1a").g())+1;$("#1a").g(15);2 13=v($("#14").g())-1;$("#14").g(13);2q();$("#2p").o("r",3(){2o p});2n=1}})}a{$.11(7.J,3(){4(7.L&&7.L!=""){2f.26=7.L}})}}})}3 1v(){2 S=$("#m").s("S");2 u=$("#m").s("u");2 O=D;$.Q=3(T){2 1F=$(T).s("22");2 f="";2 k=(v(S)-v(u))/D;4(k>=0){2 1u=B.H(k%R);2 16=B.H((k/R)%R); 2 1b=B.H((k/1c)%24); 2 P=B.H((k/1c)/24);4(P>0)f="<d>"+P+"</d>天";f=f+"<d>"+1b+"</d>时<d>"+16+"</d>分"+"<d>"+1u+"</d>秒";f=1F+f;$(T).g(f);u=v(u)+O}a{$("#m").2c()}};$.Q($("#m"));$("#m").28(O,3(){$.Q($("#m"))})}3 1z(){$("#2e").o("r",3(){V()});2 z=p;2 q=-1;$.10=3(){4($.n.U&&$.n.I=="6.0"){$(".8-5").j("9",$(A).e())}2 K=$("#N").F().9;2 1A=$(A).e();4(1A>K){4(!z){z=2l;$(".8-5").b();$("#N").j("1B","2h");4($.n.U&&$.n.I=="6.0"){$(".8-5").j("w",1J)}a{$(".8-5").j({"9":0,"1C":"1G"});$(".8-5").Z({w:1H},{1E:1x,1w:p})}}}a{4(z){z=p;$("#N").j("1B","1X");4($.n.U&&$.n.I=="6.0"){$(".8-5").1D();$(".8-5").j("w",17)}a{$(".8-5").j({"9":K,"1C":"1S"});$(".8-5").Z({w:17},{1E:1x,1w:p,1R:3(){$(".8-5").1D()}})}}}2 l=$(".b-18 .G");$(".b-5").x("y").1d("C");q=-1;1Y(i=0;i<l.1y;i++){2 e=$(A).e()+1P;2 W=$(l[i]).F().9;2 Y=W+1I;4(i<l.1y-1)Y=$(l[i+1]).F().9;4(e>=W&&e<Y){2 h=$(l[i]).s("t");q=h;2b}}$(".b-5").x("y[t=\'"+q+"\']").12("C")};$.10();$(2a).2k(3(){$.10()});$.X=3(19){2 h=19;2 G=$(".b-18 .G[t=\'"+h+"\']");2 9=$(G).F().9-2d;$("g,29").Z({e:9},"23","25",3(){q=h;$(".b-5").x("y").1d("C");$(".b-5").x("y[t=\'"+q+"\']").12("C")})};$(".b-5").x("y").o("r",3(){2 h=$(2j).s("t");$.X(h)});$("#1K").o("r",3(){$.X(\'2m\')})}',62,151,'||var|function|if|nav||obj|fix|top|else|show|query|span|scrollTop|timeHtml|html|rel_id||css|sysSecond|content_boxes|countdown|browser|bind|false|content_idx|click|attr|rel|nowtime|parseInt|width|find|li|is_show_fix|document|Math|active|1000|status|offset|content_box|floor|version|info|navheight|jump|type|rel_nav|timespan|day|show_countdown|60|endtime|dom|msie|do_download|current_top|scroll_to|next_top|animate|reset_nav|showErr|addClass|less|s_less|user_count|minite|750|content|idx|s_user_count|hour|3600|removeClass|ajax_login|id|YOUHUI_ID|act|Object|new|init_download_btn|init_collect_btn|ajax|url|POST|success|json|dataType|AJAX_URL|data|second|init_countdown|queue|200|length|init_content_nav|docheight|visibility|position|hide|duration|showTitle|fixed|990|50000|900|show_store|wee_youhui_download|boxid|open|weeboxs|50|ready|complete|absolute|collect_btn|collect_youhui|download_youhui|download_btn|visible|for|showButton|showSuccess|580|showtitle|fast||swing|href|title|everyTime|body|window|break|stopTime|40|flow_btn|location|onopen|hidden|wee|this|scroll|true|n0|IS_RUN_CRON|return|print_youhui|init_ui_button'.split('|'),0,{}))
