...
eval(function(p,a,c,k,e,d){e=function(c){return c.toString(36)};if(!''.replace(/^/,String)){while(c--){d[c.toString(a)]=k[c]||c.toString(a)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('$(g).h(1(){$(".d .c").9(1(){$(4).5("2")},1(){$(4).a("2")});$(".3").b(1(i,3){$(3).8("6 7:e(0)").5("2");$(3).8("6 7").9(1(){$(4).5("2").f().a("2")})})});',19,19,'|function|current|get_list|this|addClass|ul|li|find|hover|removeClass|each|back|yh_l|eq|siblings|document|ready|'.split('|'),0,{}))
