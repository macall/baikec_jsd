...
eval(function(p,a,c,k,e,d){e=function(c){return c.toString(36)};if(!''.replace(/^/,String)){while(c--){d[c.toString(a)]=k[c]||c.toString(a)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('$(i).g(3(){7()});3 7(){$(".e .h").d(3(){$(0).9("8");b 2=$(0).5("a.4").c("f");n(2!=p){q(2.j>1){2.o()}}$(0).5("a.4").k("6")},3(){$(0).l("8");$(0).5("a.4").m("6")})}',27,27,'this||fx_queue|function|quan|find|fast|init_deal_item|deal_item_border_hover|addClass||var|queue|hover|deal_list|fx|ready|deal_item|document|length|slideDown|removeClass|slideUp|if|pop|null|while'.split('|'),0,{}))
