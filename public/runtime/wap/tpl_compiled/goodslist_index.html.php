...
?>
				...
				<div class="content">
					<div class="list-view bor_none">
						 <ul class="tuan_ul">
						 	<?php $_from = $this->_var['data']['item']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goodslist');if (count($_from)):
    foreach ($_from AS $this->_var['goodslist']):
?>
						 	<li class="tuan_li">
						 	     <a href="<?php
echo parse_wap_url_tag("u:index|goodsdesc#index|"."id=".$this->_var['goodslist']['goods_id']."".""); 
?>">
						 	     	<div class="list_item">
						 	     		 <div class="pic">
						 	     		 	<img src="<?php echo $this->_var['goodslist']['image']; ?>" width="140" height="85">
											<?php if ($this->_var['goodslist']['is_hot'] == 1): ?><i class="tuan_ico hot">热</i><?php endif; ?>
						 	     		 </div>
										 <div class="info">
										 	<h2><?php echo $this->_var['goodslist']['sub_name']; ?></h2>
											<h3> <?php echo $this->_var['goodslist']['goods_brief']; ?></h3>
											<div class="tuan_price">
						                         <p class="price">
						                         	 <em><?php echo $this->_var['goodslist']['cur_price']; ?><i>元</i></em>
													 <del><?php echo $this->_var['goodslist']['ori_price']; ?>元</del>
												 </p>
						                         <p class="bought"><i></i>已售<?php echo $this->_var['goodslist']['buy_count']; ?></p>
						                     </div>
										 </div>
						 	     	</div>
						 	     </a>
