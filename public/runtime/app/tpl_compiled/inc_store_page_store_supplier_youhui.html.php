...
<div class="data_list">
		<dl>
        	<dt class="clearfix">
				...
				<span class="dl_salecount">下载量</span>
        	</dt>   
...
?>" /></a>
				...
				<span class="dl_youhui_end_time">
					<?php if ($this->_var['data']['end_time'] > 0): ?>			
						<em class="iconfont">&#xe607;</em>&nbsp;有效期至<?php 
$k = array (
  'name' => 'to_date',
  'v' => $this->_var['data']['end_time'],
  'f' => 'Y.m.d',
);
echo $k['name']($k['v'],$k['f']);
?>	
				...
				<span class="dl_salecount"><?php echo $this->_var['data']['user_count']; ?></span>
			</dd>
