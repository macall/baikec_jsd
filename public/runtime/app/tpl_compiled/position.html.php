...
var CITY_NAME = '<?php echo $this->_var['city_name']; ?>'
var DO_POSITION_URL = '<?php
echo parse_url_tag("u:index|position#do_posiotn|"."".""); 
?>';
var MARKER_ICON = "<?php echo $this->_var['TMPL']; ?>/images/css_bg/markers_icon.png";
var BAIDU_APPKEY = '<?php 
$k = array (
  'name' => 'app_conf',
  'value' => 'BAIDU_MAP_APPKEY',
);
