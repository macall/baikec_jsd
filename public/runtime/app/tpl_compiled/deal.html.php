...
?> clearfix">
	<div class="deal_introduce clearfix border">
	    	<h1 class="title"><?php if ($this->_var['deal']['supplier_info']): ?>[<?php echo $this->_var['deal']['supplier_info']['name']; ?>]<?php endif; ?><?php echo $this->_var['deal']['sub_name']; ?></h1>
	    	<p class="details">
...
?>
					...
					<div class="roduct_button clearfix">
						...
						<?php endif; ?>
						<?php if ($this->_var['deal']['time_status'] == 1): ?>
						<button class="ui-button disabled f_l" rel="disabled" type="button" id="buy_btn"><?php if ($this->_var['deal']['buy_type'] == 1): ?>立即兑换<?php else: ?>立即购买<?php endif; ?></button><!--disabled-->
						<?php endif; ?>
