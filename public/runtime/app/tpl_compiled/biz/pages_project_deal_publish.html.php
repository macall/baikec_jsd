								...
								<table class="form_teble_box add_border">
									...
									<tbody>
										...
										<tr>
											...
											<td class="t_field_value"><input class="ui-textbox" name="sub_name" value=""/>&nbsp;<span class="t_tip">[用于团购券，邮件，短信，列表展示的显示，字数不得超过20个字]</span></td>
										</tr>	
										<tr>
								...
								<table class="form_teble_box add_border">
									...
									<tbody>
										<tr>
											...
											<td class="t_field_value"><input class="ui-textbox" name="begin_time" value="" readonly="readonly" /><a href="javascript:void(0);" class="clear_input_btn " title="清空时间">清空</a><span class="t_tip">[不设置表示团购开始无限制]</span></td>
										</tr>	
										<tr>
											<td class="t_field_name">团购结束时间:</td>
											<td class="t_field_value"><input class="ui-textbox" name="end_time" value=""/><a href="javascript:void(0);" class="clear_input_btn " title="清空时间">清空</a><span class="t_tip">[不设置表示团购结束无限制]</span></td>
										</tr>	
								...
								<table class="form_teble_box add_border">
									...
									<tbody>
										...
										<tr class="coupon_time_type_day hide">
											...
											<td class="t_field_value"><input class="ui-textbox" name="coupon_day" value=""/></td>
										</tr>
										<tr class="coupon_time_type_datetime">
											<td class="t_field_name">团购券生效时间:</td>
											<td class="t_field_value"><input class="ui-textbox" name="coupon_begin_time" value=""/></td>
										</tr>	
										<tr class="coupon_time_type_datetime">
											<td class="t_field_name">团购券到期时间:</td>
											<td class="t_field_value"><input class="ui-textbox" name="coupon_end_time" value=""/></td>
										</tr>
										<tr>
